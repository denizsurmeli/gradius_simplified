...
/*
	...
	@return Ship
*/
Ship::Ship() : MovingSpaceObject(SpaceObjectConstants::SPACE_X / 2, SpaceObjectConstants::SPACE_Y / 2, ShipConstants::DIM_X, ShipConstants::DIM_Y, new olc::Sprite(ShipConstants::SPRITE_LOCATION), ShipConstants::SPEED), canFire{ true }, canUseNuclear{ false }, hitCount{ 0 } {
};
